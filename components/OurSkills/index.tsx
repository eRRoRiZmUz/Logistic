...
const OurSkills = () =>{
    ...
    return(
        ...
        <div className="md:flex w-full space-y-10 md:space-y-0">
            <div className="md:w-1/2 w-full h-full md:absolute left-0 top-0 ">
            ...
            <div className=" space-y-5  md:w-1/2 ">
                ...
                <div className="font-bold text-xl md:text-2xl lg:text-3xl">You ca achive and Progress information  <a className="text-red-500">Skill</a> Development.</div>
