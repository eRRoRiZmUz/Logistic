    ...
    <div className="  space-y-10 py=10 md:py-20 container mx-auto px-10 md:px-40 ">
           <div className="space-y-2.5 text-center px-10 md:px-40 lg:px-60">
                ...
                <div data-sal="slide-down"
                 data-delay="1000"
                 data-sal-duration={1000} className="font-semibold text-xl md:text-2xl lg:text-3xl">We are Interested for Your <a className="text-red-500">Service</a> of Ocean Freight</div>
                <div data-sal="slide-down"
                 data-delay="1000"
