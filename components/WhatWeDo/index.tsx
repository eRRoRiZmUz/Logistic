    ...
    return(
        ...
        <div className="md:flex md:space-x-10 space-y-10 md:space-y-0">
            <div className="space-y-5 w-full md:w-2/3 ">
                ...
                <div className="font-bold text-xl md:text-2xl lg:text-3xl">Your Goal to work Logistic  <a className="text-red-500">Activities</a> Solution of Business</div>
            ...
            <div className="md:w-1/2 w-full h-full md:absolute right-0 top-0 ">
