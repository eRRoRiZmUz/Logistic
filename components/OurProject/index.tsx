...
const OurProject = () =>{
    ...
    <div className=" py-10 md:py-20 space-y-10">
        <div className="space-y-2.5 text-center px-10 md:px-40 lg:px-60">
            ...
            <div data-sal={"slide-up"} data-sal-delay={"100"} data-sal-easing={"slide-down"} className="font-bold text-xl md:text-2xl lg:text-3xl">Client are Interested for <a className="text-red-500">Logistic</a> Service of Ocean Freight</div>                
        ...
        <Slider  {...settings}>
            {data.map((item)=>(
                    <div className="w-full p-3 group " data-sal={"slide-up"} data-sal-delay={"100"} data-sal-easing={"slide-down"}>
