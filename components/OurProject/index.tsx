    ...
    <div className=" py-10 md:py-20 space-y-10">
        <div className="space-y-2.5 text-center px-10 md:px-40 lg:px-60">
            ...
            <div data-sal="slide-down"
                 data-delay="1000"
                 data-sal-duration={1000} className="font-bold text-xl md:text-2xl lg:text-3xl">Client are Interested for <a className="text-red-500">Logistic</a> Service of Ocean Freight</div>                
            <div data-sal="slide-down"
                 data-delay="1000"
